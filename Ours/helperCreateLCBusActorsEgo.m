...
saveVarsTmp{1}(3, 1).DataType = 'Bus: BusVehiclePoseNoAccel';
...
saveVarsTmp{1}(8, 1).Name = 'AngularVelocity';
saveVarsTmp{1}(8, 1).Complexity = 'real';
saveVarsTmp{1}(8, 1).Dimensions = [1 3];
...
% saveVarsTmp{1}(9, 1).Name = 'SteeringAngle';
...
BusVehiclePoseNoAccel = Simulink.Bus;
BusVehiclePoseNoAccel.Description = '';
BusVehiclePoseNoAccel.DataScope = 'Auto';
BusVehiclePoseNoAccel.HeaderFile = '';
BusVehiclePoseNoAccel.Alignment = -1;
saveVarsTmp{1} = Simulink.BusElement;
saveVarsTmp{1}.Name = 'ActorID';
saveVarsTmp{1}.Complexity = 'real';
saveVarsTmp{1}.Dimensions = [1 1];
...
saveVarsTmp{1}(7, 1).DocUnits = '';
saveVarsTmp{1}(7, 1).Description = '';
BusVehiclePoseNoAccel.Elements = saveVarsTmp{1};
clear saveVarsTmp;
assignin('base', 'BusVehiclePoseNoAccel', BusVehiclePoseNoAccel);
