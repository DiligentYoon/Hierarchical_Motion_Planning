 classdef HelperPlotLCPlannerStatus_RMC < matlab.System
    ...
    %----------------------------------------------------------------------
    methods
        function obj = HelperPlotLCPlannerStatus_RMC(varargin)
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            if obj.EnableChaseView && obj.EnableTrajChase
                ...
                legend(obj.HAxisChase,hChase,...
                    {'optimal','colliding','infeasible','not picked'},...
        ...
        function stepImpl(obj, varargin)
            ...
            if obj.EnableChaseView || obj.EnableTopView
                ...
                % if obj.FrameCount == 0
                %     imwrite(imgInd, cm, obj.GifFilename, 'gif', 'Loopcount', inf, 'DelayTime', 0.1);
                % else
                %     imwrite(imgInd, cm, obj.GifFilename, 'gif', 'WriteMode', 'append', 'DelayTime', 0.1);
                % end
        ...
        function varargout  = getInputNamesImpl(obj)
             ...
             varargout{1}  = 'VisualizationInfo';
             varargout{2}  = 'TargetActorsWorld';
