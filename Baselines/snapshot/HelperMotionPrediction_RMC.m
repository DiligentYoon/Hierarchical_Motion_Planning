classdef HelperMotionPrediction_RMC<matlab.System
    ...
    methods(Access = protected)
        ...
        %------------------------------------------------------------------
        function [FutureRelativeTrajectories,...
                    FutureGlobalTrajectories,...
                    FutureGlobalCoordTrajectories]   = stepImpl(obj, MIOs_Global, MapInfo, MIOs_Relative, Params)
    ...
    methods(Access = protected)
        ...
        function [futureRelativeTrajectory, futureGlobalTrajectory, futureGlobalCoordTrajectory] = getOutputSizeImpl(~)
        ...
        %------------------------------------------------------------------
        function [futureRelativeTrajectory, futureGlobalTrajectory, futureGlobalCoordTrajectory] = getOutputDataTypeImpl(~)
        ...
        %------------------------------------------------------------------
        function [futureRelativeTrajectory, futureGlobalTrajectory, futureGlobalCoordTrajectory] = isOutputComplexImpl(~)
        ...
        %------------------------------------------------------------------
        function [futureRelativeTrajectory, futureGlobalTrajectory, futureGlobalCoordTrajectory] = isOutputFixedSizeImpl(~)
